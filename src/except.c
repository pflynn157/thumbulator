...
void except_enter(const u32 exceptID)
{
    ...
    u32 * frame_ptr = (u32 *)(uintptr_t)cpu_get_sp();
    ...
    simStoreData((u32)(uintptr_t)&frame_ptr[0], cpu_get_gpr(0));
    simStoreData((u32)(uintptr_t)&frame_ptr[1], cpu_get_gpr(1));
    simStoreData((u32)(uintptr_t)&frame_ptr[2], cpu_get_gpr(2));
    simStoreData((u32)(uintptr_t)&frame_ptr[3], cpu_get_gpr(3));
    simStoreData((u32)(uintptr_t)&frame_ptr[4], cpu_get_gpr(12));
    simStoreData((u32)(uintptr_t)&frame_ptr[5], cpu_get_lr());
    simStoreData((u32)(uintptr_t)&frame_ptr[6], cpu_get_pc() - 0x4);

    u32 psr = cpu_get_apsr();
    simStoreData((u32)(uintptr_t)&frame_ptr[7], (psr & 0xFFFFFC00) | (frame_align << 9) |  (psr & 0x1FF));
...
void except_exit(const u32 pType)
{
    ...
    simLoadData((u32)(uintptr_t)&frame_ptr[0], &value);
    cpu_set_gpr(0, value);
    
    simLoadData((u32)(uintptr_t)&frame_ptr[1], &value);
    cpu_set_gpr(1, value);
    
    simLoadData((u32)(uintptr_t)&frame_ptr[2], &value);
    cpu_set_gpr(2, value);
    
    simLoadData((u32)(uintptr_t)&frame_ptr[3], &value);
    cpu_set_gpr(3, value);
    
    simLoadData((u32)(uintptr_t)&frame_ptr[4], &value);
    cpu_set_gpr(12, value);
    
    simLoadData((u32)(uintptr_t)&frame_ptr[5], &value);
    cpu_set_lr(value);
    
    simLoadData((u32)(uintptr_t)&frame_ptr[6], &value);
    cpu_set_pc(value);
    
    simLoadData((u32)(uintptr_t)&frame_ptr[7], &value);
    cpu_set_apsr(value);
